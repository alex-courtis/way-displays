...
typedef void *(*fn_yaml_root_to_type)(const yaml_node_t *root);
 ...
 */
void yaml_unmarshal_log_prefix       (const char *prefix);    // message prefix
void yaml_unmarshal_log_def          (const char *def);       // default value
