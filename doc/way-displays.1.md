...
**`way-displays`** \[**`--help`**\|**`--version`**\]

**Server:**  
**`way-displays`** \[*OPTIONS*\] \[**`--config`** *path*\]

**Client:**  
**`way-displays`** \[*OPTIONS*\] \<**`--get`**\|**`--list`**\>

**`way-displays`** \[*OPTIONS*\] **`--set`** \<*SET OPTIONS*\>

**`way-displays`** \[*OPTIONS*\] **`--toggle`** \<*TOGGLE OPTIONS*\>

**`way-displays`** \[*OPTIONS*\] **`--delete`** \<*DELETE OPTIONS*\>

**`way-displays`** \[*OPTIONS*\] \<**`--write`**\|**`--reapply`**\>
...
**`-c`**, **`--c[onfig]`** \<*path*\>  
Server configuration file, falls back to defaults if not found.
