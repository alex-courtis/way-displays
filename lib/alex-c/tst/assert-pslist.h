...
void _assert_pslist_equal(struct Pslist *a, struct Pslist *b, fn_pred_pp equal_val, fn_str str_val, const char * const file, const int line) {
...
void _assert_pslist_not_equal(struct Pslist *a, struct Pslist *b, fn_pred_pp equal_val, fn_str str_val, const char * const file, const int line) {
	if (pslist_equal(a, b, equal_val)) {
		fs_file_write("actual.pslist", pslist_str(a, str_val), "w");
		fs_file_write("expected.pslist", pslist_str(b, str_val), "w");
		cmocka_print_error("\n%s == \n%s\n",  pslist_str(a, str_val), pslist_str(b, str_val));
