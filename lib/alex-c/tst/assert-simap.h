...
void _assert_simap_equal_ordered(const struct SImap *a, const struct SImap *b, const char * const file, const int line) {
	if (!simap_equal_ordered(a, b)) {
		fs_file_write("actual.simap", simap_str(a), "w");
		fs_file_write("expected.simap", simap_str(b), "w");
		cmocka_print_error("\n%s != \n%s\n",  simap_str(a), simap_str(b));
		_fail(file, line);
...
#define assert_simap_equal_ordered(a, b) _assert_simap_equal_ordered(a, b, __FILE__, __LINE__)

void _assert_simap_not_equal_ordered(const struct SImap *a, const struct SImap *b, const char * const file, const int line) {
	if (simap_equal_ordered(a, b)) {
		fs_file_write("actual.simap", simap_str(a), "w");
		fs_file_write("expected.simap", simap_str(b), "w");
		cmocka_print_error("\n%s == \n%s\n",  simap_str(a), simap_str(b));
...
#define assert_simap_not_equal_ordered(a, b) _assert_simap_not_equal_ordered(a, b, __FILE__, __LINE__)
