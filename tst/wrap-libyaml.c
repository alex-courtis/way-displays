...
int __real_yaml_document_initialize(yaml_emitter_t *emitter);
int __wrap_yaml_document_initialize(yaml_emitter_t *emitter) {
	...
	return __real_yaml_document_initialize(emitter);
}


int __real_yaml_document_add_mapping(yaml_emitter_t *emitter);
int __wrap_yaml_document_add_mapping(yaml_emitter_t *emitter) {
	...
	return __real_yaml_document_add_mapping(emitter);
}
