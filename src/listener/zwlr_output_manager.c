...
static void head(void *data,
	...
	log_debug("EVENT: zwlr_output_manager_v1_listener head %p", (void*)zwlr_output_head_v1);
...
static void done(void *data,
	...
	log_debug("EVENT: zwlr_output_manager_v1_listener done serial=%u", serial);
...
static void finished(void *data,
	...
	log_debug("EVENT: zwlr_output_manager_v1_listener finished");
